 ...
 *
 * mex mex_apriltags.cpp -I/usr/include/eigen3 -Iethz_apriltag2/include -L/usr/local/lib/ -Lethz_apriltag2/build/devel/lib/ -lopencv_core -lopencv_imgproc -lopencv_highgui -lethz_apriltag2 -lopencv_imgcodecs
 * mex mex_apriltags.cpp -I/usr/include/eigen3 -Iethz_apriltag2/include -L/opt/ros/kinetic/lib/ -Lethz_apriltag2/build/devel/lib/ -lopencv_core.so -lopencv_imgproc.so -lopencv_highgui.so -lethz_apriltag2.so
 * Note: Paths should be customized:
 *          * /usr/include/eigen3 to the include dir of eigen3
 *          * /opt/ros/indigo/lib/ to the lib dir where libapriltags.so resides
 *          /home/adrian/apriltags/build/lib
 *
     ...
     const mxArray *prhs[])
{
  ...
  std::string file_name = mxArrayToString(prhs[0]);
