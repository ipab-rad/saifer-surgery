...
{
    nh_.param("frame_id", tf_frame_, std::string("/head_mount_kinect2_ir_optical_frame"));
...
PLUGINLIB_EXPORT_CLASS( publish_selected_patch::SelectedPointsPublisher, rviz::Tool )
